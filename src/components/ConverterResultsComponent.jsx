                  ...
                  <table>
                    <tr>
                      ...
                      <td>
                        ...
                        below, the converted rows will be copied to your computer's clibboard and a new window will open the file's editor on DCS (<em>make sure your browser allows popups for this site</em>).
                        In the DCS Editor, select all the existing text and replace with your copied text. Scroll down below the editor
                        ...
                        and click <stong><em>Commit Changes</em></stong>.
                      </td>
                    </tr>
                  </table>
                </>
